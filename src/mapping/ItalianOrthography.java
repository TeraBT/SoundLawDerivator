...
public class ItalianOrthography implements Orthography {
    ...
    public ItalianOrthography() {
        ...
        representativeToSymbolMap.put("ci", List.of(IPASymbol.VOICELESS_ALVEOLAR_PLOSIVE, IPASymbol.VOICELESS_POSTALVEOLAR_FRICATIVE, IPASymbol.I));
        representativeToSymbolMap.put("ce", List.of(IPASymbol.VOICELESS_ALVEOLAR_PLOSIVE, IPASymbol.VOICELESS_POSTALVEOLAR_FRICATIVE, IPASymbol.E));

        representativeToSymbolMap.put("gi", List.of(IPASymbol.VOICED_ALVEOLAR_PLOSIVE, IPASymbol.VOICED_POSTALVEOLAR_FRICATIVE, IPASymbol.I));
        representativeToSymbolMap.put("ge", List.of(IPASymbol.VOICED_ALVEOLAR_PLOSIVE, IPASymbol.VOICED_POSTALVEOLAR_FRICATIVE, IPASymbol.E));
