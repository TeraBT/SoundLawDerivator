...
//        System.out.println(TextReader.read("corpora/test.txt"));
        ...
        List<List<IPASymbol>> latinSymbolTokens = StringPreprocessor.tokenizeDistinctToIPASymbolSequence(XMLParser.parseOnlyText("corpora/Julius-Caesar_De-bello-Gallico.xml"), sigmaMapperLatin, 16);
        List<List<IPASymbol>> italianSymbolTokens = StringPreprocessor.tokenizeDistinctToIPASymbolSequence(XMLParser.parseOnlyText("corpora/de_bello_gallico_italiano.html"), sigmaMapperItalian, 16);
...
//        List<String> italianoSmall = italianoTokens.subList(0, 100);
        RepresentativeWorkerOrganizer woRepresentatives = new RepresentativeWorkerOrganizer(latinTokens, italianTokens, 16, 16);
        SymbolWorkerOrganizer woSymbols = new SymbolWorkerOrganizer(latinSymbolTokens, italianSymbolTokens, 16, 16);
